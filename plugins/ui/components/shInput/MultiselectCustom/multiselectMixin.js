...
export default {
  ...
  props: {
    ...
    /**
     * suggest the search input after `)
     * @default false
     * @type {Boolean}
     */
    isSuggest: {
  ...
  mounted() {
    ...
    this.$refs.list.addEventListener('wheel', (event) => {
      ...
      this.$refs.list.scroll(this.$refs.list.scrollLeft, this.$refs.list.scrollTop + -event.wheelDelta);
    });
  },
  computed: {
    internalValue() {
  ...
  methods: {
    ...
    adjustPosition() {
      ...
      const parentEl = getParentsTarget(this.$el, this.classParent);

      const spaceAbove = this.$el.getBoundingClientRect().top;
      let spaceBelow = window.innerHeight - this.$el.getBoundingClientRect().bottom;
      let hasEnoughSpaceBelow = spaceBelow > this.maxHeight;
      if (!!parentEl) {
        try {
          spaceBelow =
            getParentsTarget(this.$el, this.classParent).clientHeight +
            getParentsTarget(this.$el, this.classParent).getBoundingClientRect().top -
